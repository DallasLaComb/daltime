...
|---|---|---|---|---|---|---|---|
| 1 | notifications path-params | 4 | — (already on `ApiClient`) | `contracts/notifications-path-params` |  |  | contract-hardening only |
| 2 | org-admin profile | 2 | `org-admin/profile/profile.service.ts` | `contracts/org-admin-profile` | ⬜ pending | — | first full vertical slice |
...
| 6 | manager locations | 1 | `manager/shifts-needed/locations.service.ts` | `contracts/manager-locations` | ⬜ pending | — |  |
| 7 | manager shifts | 4 | `manager/schedule/shifts.service.ts`, `org-admin/schedule/shifts.service.ts` | `contracts/manager-shifts` | ⬜ pending | — |  |
| 8 | manager shifts-needed | 4 | `manager/shifts-needed/shifts-needed.service.ts` | `contracts/manager-shifts-needed` | ⬜ pending | — |  |
